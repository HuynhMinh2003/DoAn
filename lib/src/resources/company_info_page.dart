...
class _CompanyInfoPageState extends BaseCompanyInfoScreen<CompanyInfoPage> {
  double xPosition = 20;
          ...
          if (e.code == 'requires-recent-login') {
            ...
            if (reauthPassword != null && reauthPassword.isNotEmpty) {
              try {
                ...
                await updateFirestore(); // Cập nhật phone
                return;
              } on FirebaseAuthException catch (e) {
  ...
  Widget build(BuildContext context) {
    final avatarProvider = Provider.of<CompanyImageProvider>(context);
      ...
      children: [
        Scaffold(
          ...
          body: isLoading
              ...
              : companyInfo == null
              ? const Center(child: Text("Không có thông tin công ty."))
              : Align(
  ...
  void showEditDialog(BuildContext context) {
    ...
    showDialog(
      context: context,
      builder: (context) {
        return Consumer<CompanyImageProvider>(
          builder: (context, imageProvider, _) {
            return AlertDialog(
              title: Center(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ClipOval(
                      child: SizedBox(
                        ...
                        child: imageProvider.webImageBytes != null
                            ...
                            : (companyInfo?.imageUrl?.isNotEmpty ?? false)
                            ? Image.network(companyInfo!.imageUrl!,
                            fit: BoxFit.cover,
                    ...
                    ElevatedButton.icon(
                      ...
                      label: Text('Đổi ảnh đại diện', style: TextStyle(fontSize: 15.sp,color: Colors.black)),
                    ...
                    try {
                      ...
                      if (imageProvider.webImageBytes != null ||
                        ...
                        newUrl = await imageProvider.uploadSelectedImageAndGetUrl1(
                          ...
                          uniqueFileName,
                          oldImageUrl: companyInfo!.imageUrl,
                        );
