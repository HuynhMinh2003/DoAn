...
class CSNScreen extends StatefulWidget {
  final String contractId;

  const CSNScreen({super.key, required this.contractId});

  @override
  State<CSNScreen> createState() => _CSNScreenState();
}

class _CSNScreenState extends State<CSNScreen> {
  int _selectedTab = 0;
