...
class ContractFormSalePage extends StatefulWidget {
  ...
  const ContractFormSalePage({super.key, required this.apartmentId});

  @override
  State<ContractFormSalePage> createState() => _ContractFormSalePageState();
}

class _ContractFormSalePageState extends State<ContractFormSalePage> {
  ...
  final timepayattentionController = TextEditingController();
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
              ...
              child: Material(
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        Text('Ngày thanh toán: ', style: TextStyle(fontSize:4.sp,fontWeight: FontWeight.bold)),
                        Expanded(
                          child: Text(
                            timepay != null
                                ? dateFormat.format(timepay!)
                                : 'Chưa chọn',
                            style: TextStyle(fontSize: 4.sp),
                            overflow: TextOverflow.ellipsis,
                          ),
            ...
            SizedBox(height: 30.h,),
            TextField(
              controller: timepayattentionController,
              decoration: InputDecoration(labelText: '(Chia làm mấy đợt, số tiền và thời hạn)',labelStyle: TextStyle(fontSize: 4.sp, fontWeight: FontWeight.bold)),
            ),
            SizedBox(height: 30.h,),
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      ...
                      try {
                        ...
                        String apartmentId = widget.apartmentId; // Cần lấy id căn hộ thực tế
                        ...
                        final templateData = await rootBundle.load('assets/templates/hd_mua_ch.docx');
                        ...
                        content
                          ...
                          ..add(TextContent("time_pay",  formatCustomDate(timepay!)))
                          ..add(TextContent("time_pay_attention",  timepayattention));
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              title: Center(child: Text("Thất bại",
                                  style: TextStyle(fontSize: 5.sp)),),
                              content: Text("Hợp đồng tạo thất bại!",
                                  style: TextStyle(fontSize: 4.sp)),
                              actions: [
                                TextButton(
                                  onPressed: () {
