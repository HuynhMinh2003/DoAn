...
import 'package:do_an/src/resources/staff/water_reading_history_page.dart';
import 'package:do_an/src/resources/staff/water_reading_screen.dart';
...
class CSNPage extends StatefulWidget {
  const CSNPage({super.key});

  @override
  State<CSNPage> createState() => _CSNPageState();
}

class _CSNPageState extends BaseStaffInfoScreen<CSNPage> {
  @override
  void initState() {
    super.initState();
