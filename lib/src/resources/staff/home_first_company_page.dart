...
import '../company/company_info_page.dart';
import '../company/company_page.dart';
import '../notification/notification_list_company_page.dart';
...
class _HomeFirstPageState extends BaseCompanyInfo<HomeFirstPage> {
  ...
  Future<void> syncEmailWithFirestore() async {
    ...
    final docSnapshot = await _firestore.collection('companies').doc(uid).get();
