...
abstract class BaseCompanyInfoScreen<T extends StatefulWidget> extends State<T> {
  ...
  void initState() {
    super.initState();
    getCompanyInfo();  // Không cần truyền tham số, mặc định lấy theo UID hiện tại
  }
  ...
  Future<void> getCompanyInfo([String? companyId]) async {
    try {
      ...
      print('⚠️ Lỗi khi lấy thông tin công ty: $e');
