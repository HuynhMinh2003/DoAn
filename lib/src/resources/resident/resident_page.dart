...
import 'package:do_an/src/resources/staff/csn_screen_page.dart';
import 'package:do_an/src/resources/login_page.dart';
import 'package:do_an/src/resources/resident/payment_summary_screen_page.dart';
import 'package:do_an/src/resources/resident/pdf_viewer_screen.dart';
import 'package:do_an/src/resources/provider/resident_image_provider.dart';
import 'package:do_an/src/resources/resident/report_page.dart';
import 'package:do_an/src/resources/resident/resident_contract_summary_screen.dart';
...
class _ResidentPageState extends BaseResidentInfo<ResidentPage> {
  @override
  void initState() {
    super.initState();
                          ...
                          GridView.count(
                            ...
                            children: [
                              buildServiceCard(
                                ...
                                label: 'Gửi xe',
                                onTap: isEffective ? () {
                                  Navigator.push(context, MaterialPageRoute(builder: (_) => AddParkingPage()));
                                } : null,
                              ),
                              buildServiceCard(
                                context,
                                ...
                                onTap: isEffective ? () {
                                  ...
                                  if (contractId != null && contractId.isNotEmpty) {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (_) => CSNScreenPage(contractId: contractId)),
                                    );
                                  } else {
          ...
          child: GestureDetector(
            ...
            child: Material(
              ...
              child: InkWell(
                ...
                borderRadius: BorderRadius.circular(12),
                splashColor: onTap == null ? Colors.transparent : Colors.blue.withValues(alpha: 0.2),
                highlightColor: onTap == null ? Colors.transparent : Colors.blue.withValues(alpha: 0.1),
                child: Container(
          ...
          child: GestureDetector(
            ...
            child: Material(
              ...
              child: InkWell(
                ...
                borderRadius: BorderRadius.circular(12),
                splashColor: isEnabled ? Colors.blue.withValues(alpha: 0.2) : Colors.transparent,
                highlightColor: isEnabled ? Colors.blue.withValues(alpha: 0.1) : Colors.transparent,
                child: Container(
                  width: 110,
                  height: 110,
                  decoration: BoxDecoration(
                    border: Border.all(
                      color: isEnabled ? Colors.transparent : Colors.grey.withValues(alpha: 0.2),
                      width: 1.2,
                    ),
                    borderRadius: BorderRadius.circular(12),
                  ),
