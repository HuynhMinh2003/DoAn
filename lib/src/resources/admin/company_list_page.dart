...
import 'package:do_an/src/resources/admin/company_list_mobile_page.dart' if (dart.library.html) 'company_list_web_page.dart';
...
class _CompanyListPageState extends State<CompanyListPage> {
  ...
  List<CompanyInfo> _allCompanyList = [];

  String? _selectedCompanyStatus;
  List<String> _companyStatusItems = ["Tất cả", "Đang hợp tác", "Đã thôi"];
  ...
  Future<bool> sendUpdatedDetailEmailFromFlutter({
    ...
    try {
      final response = await http.post(
        Uri.parse("https://sendupdateddetailemail2-ttrkrlo35a-uc.a.run.app"),
