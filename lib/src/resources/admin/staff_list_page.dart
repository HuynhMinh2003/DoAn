...
import 'staff_list_mobile_page.dart' if (dart.library.html) 'staff_list_web_page.dart';
...
class _StaffListPageState extends State<StaffListPage> {
  ...
  List<String> _employmentStatusItems = ["Tất cả", "Đang làm", "Đã nghỉ"];
  ...
  Future<bool> sendUpdatedDetailEmailFromFlutter({
    ...
    try {
      final response = await http.post(
        Uri.parse("https://sendupdateddetailemail1-ttrkrlo35a-uc.a.run.app"),
