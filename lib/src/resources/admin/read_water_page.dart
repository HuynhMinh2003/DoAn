...
class ReadWaterPage extends StatefulWidget {
  const ReadWaterPage({super.key});

  @override
  State<ReadWaterPage> createState() => _ReadWaterPageState();
}

class _ReadWaterPageState extends State<ReadWaterPage> {
                                                      ...
                                                      IconButton(
                                                        ...
                                                        onPressed: (isRented && hasContract)
                                                          ...
                                                          try {
                                                            ...
                                                            final contract = ContractData.fromMap(
