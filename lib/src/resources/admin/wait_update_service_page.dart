...
class _WaitUpdateServicePageState extends State<WaitUpdateServicePage> {
  ...
  Future<void> _updateServiceStatus(String serviceId, String newStatus) async {
    try {
      ...
      setState(() {
        _loadServicesWithCompanyInfo(); // Hoặc bạn gọi lại hàm load danh sách
      });
                                    ...
                                    child: ConstrainedBox(
                                      ...
                                      child: CustomPaginatedTable(
                                        columns: [
                                          ...
                                          DataColumn(label: Text("Giá (VNĐ)", style: TextStyle(fontSize: 4.sp))),
                                        ...
                                        rows: paginatedServices.map((service) {
                                          return DataRow(cells: [
                                            ...
                                            DataCell(Text(service['price'] != null ? "${service['price']}" : '', style: TextStyle(fontSize: 4.sp))),
                                            DataCell(
                                              Row(
                                                children: [
                                                  Icon(
                                            ...
                                            DataCell(
                                              Column(
                                                ...
                                                children: [
                                                  ...
                                                  if (service['status'] == 'Đang chờ duyệt') ...[
                                                    Row(
                                                      children: [
                                                        ElevatedButton(
                                                          ...
                                                          onPressed: () => _updateServiceStatus(service['id'], 'Đã duyệt'),
                                                          child: Text("Duyệt", style: TextStyle(fontSize: 3.sp)),
                                                        ),
                                                        SizedBox(width: 5),
                                                        ElevatedButton(
                                                          style: ElevatedButton.styleFrom(
                                                          ...
                                                          onPressed: () => _updateServiceStatus(service['id'], 'Từ chối duyệt'),
                                                          child: Text("Từ chối", style: TextStyle(fontSize: 3.sp)),
                                                        ),
                                                      ],
                                                    ),
                                                  ]
