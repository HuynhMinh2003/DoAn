...
class AddResidentsPage extends StatefulWidget {
  final int count;
  ...
  @override
  State<AddResidentsPage> createState() => _AddResidentsPageState();
}

class _AddResidentsPageState extends State<AddResidentsPage> {
                                      ...
                                      children: [
                                        Radio<String>(
                                          ...
                                          onChanged: (val) {
                                            ...
                                            _authBloc[index].changeGender(val!);
                                          },
                                        ),
                                      ...
                                      suffixIcon: IconButton(
                                        ...
                                        onPressed: () async {
                                          ...
                                          if (picked != null) {
                                            ...
                                            _authBloc[index].changeBirthDate(picked);
                                          }
                                        },
                                      ),
                                    ),
