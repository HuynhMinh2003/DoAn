...
class _StaffListPageState extends State<StaffListPage> {
  ...
  String? _selectedEmploymentStatus; // Bộ lọc trạng thái nhân viên (đã nghỉ việc hay vẫn đang làm)
...
// class _StaffsDataSource extends DataTableSource {
//   final List<Staff> staffs;
//   final BuildContext context; // Thêm context
//   final VoidCallback onRefresh; // Hàm tải lại dữ liệu
//
//   _StaffsDataSource(this.staffs, this.context, this.onRefresh);
//   final AuthBloc _authBloc = AuthBloc();
//
//   @override
...
//                 icon: Icon(Icons.edit, color: Colors.blue),
//                 onPressed: () {
//                   showEditDialog(context, staff, onRefresh);
//                 },
//               ),
//               IconButton(
//                 icon: Icon(Icons.delete, color: Colors.red),
//                 onPressed: () {
//                   showDeleteStaffDialog(context, staff, onRefresh);
//                 },
//               ),
//             ],
//             // Hiển thị icon "info" nếu isExit = true (đã nghỉ việc)
