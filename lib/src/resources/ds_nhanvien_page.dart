  ...
  void _showStaffDetails(BuildContext context, Map<String, dynamic> staff) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        title: Text(
          "Thông tin cá nhân",
          style: TextStyle(fontFamily: "Oswald", fontWeight: FontWeight.bold, fontSize: 6.sp),
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text("Họ và tên: ${staff["name"]}", style: TextStyle(fontSize: 3.5.sp)),
              SizedBox(height: 18.h),
              Text("Email: ${staff["email"]}", style: TextStyle(fontSize: 3.5.sp)),
              SizedBox(height: 18.h),
              Text("SĐT: ${staff["phone"]}", style: TextStyle(fontSize: 3.5.sp)),
              SizedBox(height: 18.h),
              Text("Vai trò: ${staff["position"]}", style: TextStyle(fontSize: 3.5.sp)),
            ],
          ),
        ),
        actions: [
