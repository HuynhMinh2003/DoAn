...
class CSNInfoPage extends StatefulWidget {
  const CSNInfoPage({Key? key}) : super(key: key);

  @override
  _CSNInfoPageState createState() => _CSNInfoPageState();
}

class _CSNInfoPageState extends BaseStaffInfoScreen<CSNInfoPage> {
  double xPosition = 20;
