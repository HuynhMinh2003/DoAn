...
class JWT extends oauth2client_1.OAuth2Client {
    ...
    fromJSON(json) {
        ...
        if (!json.***REMOVED***) {
            throw new Error('The incoming JSON object does not contain a ***REMOVED*** field');
        }
        if (!json.private_key) {
            throw new Error('The incoming JSON object does not contain a private_key field');
        }
        // Extract the relevant information from the json key file.
        this.email = json.***REMOVED***;
        this.key = json.private_key;
        this.keyId = json.private_key_id;
        this.projectId = json.***REMOVED***;
        this.quotaProjectId = json.quota_***REMOVED***;
    ...
    async getCredentials() {
        if (this.key) {
            return { private_key: this.key, ***REMOVED***: this.email };
        }
        else if (this.keyFile) {
            const gtoken = this.createGToken();
            const creds = await gtoken.getCredentials(this.keyFile);
            return { private_key: creds.privateKey, ***REMOVED***: creds.clientEmail };
        }
