...
<<<<<<< HEAD
    ***REMOVED***: string | null;
    /**
     * An alias for {@link AuthJSONOptions.***REMOVED*** `***REMOVED***`}.
     */
    projectId: AuthJSONOptions['***REMOVED***'];
=======
...
>>>>>>> origin/nhanh1
     ...
     */
<<<<<<< HEAD
    quota_***REMOVED***: string;
    /**
     * An alias for {@link AuthJSONOptions.quota_***REMOVED*** `quota_***REMOVED***`}.
     */
    quotaProjectId: AuthJSONOptions['quota_***REMOVED***'];
=======
