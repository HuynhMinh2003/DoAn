...
class AuthClient extends events_1.EventEmitter {
    constructor(opts = {}) {
        ...
        this.projectId = (_a = options.get('***REMOVED***')) !== null && _a !== void 0 ? _a : null;
        this.quotaProjectId = options.get('quota_***REMOVED***');
    ...
    addSharedMetadataHeaders(headers) {
        // quota_***REMOVED***, stored in application_default_credentials.json, is set in
