...
export interface GoogleAuthOptions<T extends AuthClient = JSONClient> {
    ...
    /**
<<<<<<< HEAD
     * Object containing ***REMOVED*** and private_key properties, or the
=======
...
<<<<<<< HEAD
     * ***REMOVED*** and private_key (if exists).
     * getCredentials first checks if the client is using an external account and
     * uses the service account email in place of ***REMOVED***.
     ...
     * ***REMOVED*** from the cloud metadata server.
     * @param callback Callback that handles the credential object that contains
     * a ***REMOVED*** and optional private key, or the error.
=======
