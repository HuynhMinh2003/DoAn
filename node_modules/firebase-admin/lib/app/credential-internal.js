...
class ApplicationDefaultCredential {
  ...
  */
    ...
    async getServiceAccountEmail() {
        ...
        const { ***REMOVED***: clientEmail } = await this.googleAuth.getCredentials();
...
class ServiceAccount {
    ...
    constructor(json) {
        ...
        copyAttr(this, json, 'projectId', '***REMOVED***');
        copyAttr(this, json, 'privateKey', 'private_key');
        copyAttr(this, json, 'clientEmail', '***REMOVED***');
        let errorMessage;
        if (!util.isNonEmptyString(this.projectId)) {
            errorMessage = 'Service account object must contain a string "***REMOVED***" property.';
        }
...
class RefreshToken {
    ...
    static validateFromJSON(json) {
        ...
        copyAttr(creds, json, 'clientSecret', '***REMOVED***');
        ...
        if (!util.isNonEmptyString(creds.clientId)) {
            ...
            errorMessage = 'Refresh token must contain a "***REMOVED***" property.';
        }
...
class ImpersonatedServiceAccount {
    ...
    static validateFromJSON(json) {
        const { client_id: clientId, ***REMOVED***: clientSecret, refresh_token: refreshToken, type } = json['source_credentials'];
        let errorMessage;
        if (!util.isNonEmptyString(clientId)) {
            ...
            errorMessage = 'Impersonated Service Account must contain a "source_credentials.***REMOVED***" property.';
        }
...
function populateGoogleAuth(keyFile, httpAgent) {
    ...
    if (typeof keyFile === 'object') {
        ...
        copyAttr(keyFile, keyFile, '***REMOVED***', 'projectId');
        copyAttr(keyFile, keyFile, 'private_key', 'privateKey');
        copyAttr(keyFile, keyFile, '***REMOVED***', 'clientEmail');
