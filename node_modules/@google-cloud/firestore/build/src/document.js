...
class Precondition {
     ...
     * Firestore,
     * @param options.lastUpdatedTime - The last update time of the referenced
    ...
    constructor(options) {
        if (options !== undefined) {
            ...
            this._lastUpdatedTime = options.lastUpdatedTime;
        }
    }
    /**
    ...
    toProto() {
        ...
        if (this._lastUpdatedTime !== undefined) {
            proto.updateTime = this._lastUpdatedTime.toProto().timestampValue;
        }
        else {
     ...
     */
    get isEmpty() {
        return this._exists === undefined && !this._lastUpdatedTime;
    }
}
