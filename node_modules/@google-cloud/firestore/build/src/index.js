 ...
 *   return documentRef.delete({ lastUpdatedTime: updateTime });
 * });
 *
 * ```
 * @property {Timestamp} lastUpdatedTime The update time to enforce. If set,
 *  enforces that the document was last updated at lastUpdatedTime. Fails the
...
<<<<<<< HEAD
     * `settings.credentials` and provide the `***REMOVED***` and `private_key` of
     * your service account.
     * @param {{***REMOVED***:string=, private_key:string=}=} settings.credentials
...
>>>>>>> origin/nhanh1
    ...
    validateAndApplySettings(settings) {
        ...
        this._settings.toJSON = function () {
            ...
            if (temp.credentials) {
<<<<<<< HEAD
                temp.credentials = { private_key: '***', ***REMOVED***: '***' };
=======
