...
export declare class FirestoreAdminClient {
     ...
     * @param {string} [options.credentials.***REMOVED***]
     ...
     *   `projects/{***REMOVED***}/databases/{database_id}/collectionGroups/{collection_id}/indexes/{index_id}`
     ...
     * @param {string} request.name
     *   Required. A name of the form
     *   `projects/{***REMOVED***}/databases/{database_id}/collectionGroups/{collection_id}/fields/{field_id}`
     * @param {object} [options]
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     ...
     * @param {string} request.name
     *   Required. A name of the form
     *   `projects/{***REMOVED***}/databases/{database_id}`
     * @param {object} [options]
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     ...
     * @param {string} request.parent
     *   Required. A parent name of the form
     *   `projects/{***REMOVED***}/databases/{database_id}/collectionGroups/{collection_id}`
     ...
     * `projects/{***REMOVED***}/databases/{database_id}/collectionGroups/__default__/fields/*`.
     *
     * @param {Object} request
     *   The request object that will be sent.
     ...
     *   backup.
     *
     *   Format is: `projects/{***REMOVED***}/locations/{location}/backups/{backup}`
