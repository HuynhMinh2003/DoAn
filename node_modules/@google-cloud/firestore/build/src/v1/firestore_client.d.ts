...
export declare class FirestoreClient {
     ...
     *   `projects/{***REMOVED***}/databases/{database_id}/documents/{document_path}`.
     ...
     *   `projects/{***REMOVED***}/databases/{database_id}/documents` or
     *   `projects/{***REMOVED***}/databases/{database_id}/documents/chatrooms/{chatroom_id}`
     ...
     * @param {string} request.parent
     *   Required. The parent resource name. In the format:
     *   `projects/{***REMOVED***}/databases/{database_id}/documents`.
