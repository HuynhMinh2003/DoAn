...
message Database {
  ...
  message CmekConfig {
    ...
    // `projects/{***REMOVED***}/locations/{kms_location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
    ...
    //
    // The expected format is
    // `projects/{***REMOVED***}/locations/{kms_location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}/cryptoKeyVersions/{key_version}`.
  ...
  // is the ***REMOVED*** (eg: foo instead of v~foo).
