...
declare namespace FirebaseFirestore {
   ...
   *         readonly lastUpdateddMillis: number
   *     ) {}
   *     toString(): string {
   ...
   *             lut: this._lutFromlastUpdateddMillis(post.lastUpdateddMillis)
   *         };
   *     }
   *
   ...
   *     }
   *
   *     _lutFromlastUpdateddMillis(
   *         lastUpdateddMillis: number | FieldValue
   *     ): Timestamp | FieldValue {
   *         if (typeof lastUpdateddMillis !== 'number') {
   *             // `lastUpdateddMillis` must be a FieldValue, so just return it.
   *             return lastUpdateddMillis;
   *         }
   *         return Timestamp.fromMillis(lastUpdateddMillis);
   *     }
   * }
   *
   ...
   *         title: 'My Life',
   *         author: 'Foo Bar',
   *         lastUpdateddMillis: FieldValue.serverTimestamp()
   *     });
   *
  ...
  export interface Settings {
     ...
     * the `credentials` property to provide the `***REMOVED***` and
     * `private_key` of your service account.
     */
    keyFilename?: string;

    /**
     * The '***REMOVED***' and 'private_key' properties of the service account
     * to use with your Firestore project. Can be omitted in environments that
     * support {@link https://cloud.google.com/docs/authentication Application
     * Default Credentials}. If your credentials are stored in a JSON file, you
     * can specify a `keyFilename` instead.
     */
    credentials?: {***REMOVED***?: string; private_key?: string};
  ...
  export class BulkWriter {
     ...
     * delete.
     * @param precondition.lastUpdatedTime If set, enforces that the
     * document was last updated at lastUpdatedTime. Fails the batch if the
